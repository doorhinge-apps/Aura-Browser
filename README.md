# Updates and stuff
Hi peoples. Aura is still being updated and is not dead. Unfortunately, it will be a while until the I have time to release a new update. I am busy with school. Additionally, I have to work on college applications and also take the SAT again. Anyway, updates will be more frequent in the summer.

### Possible Ideas
So the browser is a bit of a mess on the code side. I still barely know how to make a browser so the code is rough. There is a chance that I will entirely redesign the browser to be more stable and allow for me to continue building features on top of my existing code. Your data would be saved of course and the UI and customization options would remain the same (or have more features even).
#### What's so bad about the code?
My current code for the browser and tab management does not allow me to build new features on top of it very easily. This is partly because of WebKit, but it is also because of my programming. I need to restructure several fundamental components of the browser to make it run smoothly and support the features I want to add.
